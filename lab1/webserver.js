/**
 * Web server for the Photo Sharing App.
 * Serves model data via REST API endpoints.
 */
...
// ---- Model Data (mirrors src/modelData/models.js) ----
...
const comments = [
  ...
  { _id: "57231f1a30e4351f4e9f4beb", date_time: "2013-09-08 14:06:00", comment: "If you see this text in <b>boldface</b> then HTML escaping isn't working properly.", user: jo, photo_id: "57231f1a30e4351f4e9f4bdd" },
  { _id: "57231f1a30e4351f4e9f4bec", date_time: "2009-09-14 18:07:00", comment: "If there is one thing the history of evolution has taught us it's that life will not be contained. Life breaks free, it expands to new territories and crashes through barriers, painfully, maybe even dangerously, but, uh... well, there it is. Life finds a way.", user: im, photo_id: "57231f1a30e4351f4e9f4bde" },
  ...
  { _id: "57231f1a30e4351f4e9f4bef", date_time: "2013-11-02 14:09:15", comment: "Definitely! I love your work! I'm away on a trip at the moment, but let's meet up when I get back! :)", user: rk, photo_id: "57231f1a30e4351f4e9f4be3" },
  ...
  { _id: "57231f1a30e4351f4e9f4bf1", date_time: "2008-10-16 18:04:55", comment: "Wouldn't get anywhere without this beauty! Completely built from scraps by hand, but she goes at top speeds that'll rival any First Order piece of junk.", user: rk, photo_id: "57231f1a30e4351f4e9f4be8" },
...
app.listen(port, () => {
  ...
  console.log(`API available at http://localhost:${port}/user/list`);
});
